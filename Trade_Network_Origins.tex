...
\usepackage{sectsty}
\chapterfont{\usefont{T1}{qhv}{b}{n}\selectfont\Large} 
...
\lhead{\scshape\usefont{T1}{qhv}{b}{n}\selectfont\normalsize\leftmark}
\chead{}
\rhead{}
...
\renewcommand{\cftsubsecpagefont} % subsection page numbers
             {\cftsubsecfont}
\renewcommand\cftaftertoctitle{\par\noindent\hrulefill\par\vskip0.3em}
...
%
	...
	\title{\myfont The International Trade Network Origins of Domestic Fluctuations}
...
\section{Introduction}\thispagestyle{emptyheader} \label{intro}
...
\section{Methodology and Data} \thispagestyle{emptyheader} \label{data}
...
\section{Conclusion} \thispagestyle{emptyheader} \label{conclusion}
...
\noindent \begin{figure} \label{fig:map}
  ...
  {\centering
\includegraphics[scale=0.6, trim={1cm 0 0 0}, clip]{map/exports_centrality_growth.pdf} \\
\vspace{3mm}

\includegraphics[scale=0.6, trim={1cm 0 0 0}, clip]{map/imports_centrality_growth.pdf} \\ \par
} 
